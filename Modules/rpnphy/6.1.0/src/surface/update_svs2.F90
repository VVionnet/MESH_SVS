...
!!! S/P UPDATE_SVS
!
      SUBROUTINE UPDATE_SVS2( WDT, WFT, WR_VLT, WR_VHT, LATFLW, WATFLOW, &
           WD, WF, WR_VL, WR_VH, WDM, LATFLAF, DRAINAF, N )
...
!
      ...
      real, dimension(n) :: wr_vlt, wr_vht, wr_vl, wr_vh, wdm, latflaf, drainaf 
