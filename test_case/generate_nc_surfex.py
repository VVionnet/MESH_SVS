...
mod = mod.rename({'SNODEN_ML':'SNOWRO','SNOAGE_ML':'SNOWAGE','SNOHIST_ML':'SNOWHIST','WSNOW_ML':'SNOWLIQ','SNOSPH_ML':'SNOWSPHER','TSNOW_ML':'SNOWTEMP','SNOMA_ML':'WSN_VEG'})

# Extract variables for the generation of the SURFEX-like netcdf file
list_var = ['SNOWDZ','SNOWSSA','SNOWRO','SNOWAGE','SNOWTEMP','SNOMA','SNODP','SNODEN','SNOALB','SNOWLIQ','SNOWSPHER','WSN_VEG']
sub = mod[list_var]
...
dic_variables = {'SNOWRO':{'long_name':'Snow_density','units':'Kg/m3'},
                 'SNOWAGE':{'long_name':'Snow_age_param','units':'days_since_snowfall'},
...
sub.to_netcdf(netcdf_file_out,unlimited_dims='time')
